...
input.addEventListener("keyup", function(event) {
    ...
    newMessageBox.innerHTML = `<img src="user.jpg" alt="Avatar">
    <p>${message}</p>
    ...
    if (event.keyCode === 13) {
        ...
        else if (message.includes("why are you bored")) {
            response = random([
                "your boring bro..."
            ]);
        }
        ...
        setTimeout(function() {
            ...
            newAIresponse.innerHTML = `<img src="https://cdn3d.iconscout.com/3d/premium/thumb/ai-robot-3d-icon-download-in-png-blend-fbx-gltf-file-formats--artificial-intelligence-automation-tech-and-gadget-pack-technology-icons-9049044.png?f=webp" alt="Avatar">
            <p>${response}</p>
            <span class="time-right">${grabTime()}</span>`;
